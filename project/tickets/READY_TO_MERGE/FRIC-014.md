...
pr: https://github.com/loganbnielsen/sol/pull/145
---
...
example-dockerfile-smoke CI job matrixes the 4 real OCaml example Dockerfiles matching tpl_dockerfile's current shape, correctly excludes the hand-written TS demo_ts Dockerfiles, actionlint-clean, and independently spot-verified with a second real --no-cache docker build beyond the one already checked.
