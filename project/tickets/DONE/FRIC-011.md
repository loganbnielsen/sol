...
pr: https://github.com/loganbnielsen/sol/pull/143
---
...
ECR repos keyed on workspace_name; terraform_vars auto-derives workspace_name/ecr_repositories with an app/ guard; cmd_cloud_tf.ml destroy-verification updated to match. Build, terraform fmt/init/validate, and full dune test suite (including e2e) pass. Follow-up commit added direct test coverage for the new vars per adversarial review feedback.
