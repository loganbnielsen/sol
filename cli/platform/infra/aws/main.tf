# cli/platform/infra/aws — AWS cluster provisioning for Sol workspaces
#
# Provisions:
...
# one-off dashboard implementation. cli/platform/infra/base reads the
...
# surface is the Grafana dashboard cli/platform/infra/base provisions from the
...
module "grafana_irsa" {
  ...
  oidc_providers = {
    main = {
      ...
      # cli/platform/infra/base -- "grafana" release name -> "grafana" SA,
...
# cli/platform/infra/base's observability_backend = "self_hosted_durable" can
