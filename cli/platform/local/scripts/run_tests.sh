...
#
# Usage:
#   ./cli/platform/local/scripts/run_tests.sh                    # full run
#   ./cli/platform/local/scripts/run_tests.sh --update-baseline  # run and record timings as new baseline
#   ./cli/platform/local/scripts/run_tests.sh --no-infra         # skip infra setup (already running)
#   ./cli/platform/local/scripts/run_tests.sh --reset-infra      # recreate Sol-owned local infra first
#   ./cli/platform/local/scripts/run_tests.sh unit kafka         # run specific suites only
#
# Exit codes:
