  ...
  Alcotest.run
    ...
    ; ( "resolve"
      , [ Alcotest.test_case "local default" `Quick test_resolve_local_default
        ; Alcotest.test_case
            "self_hosted_durable with base_domain"
            `Quick
