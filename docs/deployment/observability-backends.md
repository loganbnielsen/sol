...
| `SolWorkerDecodeDrops` | undecodable source messages (dead-lettered under `Retry_topics`, else acked and dropped) | `sol_worker_decode_errors_total` | any increase in 5 minutes, `critical` |
