...
1. **Cluster/cloud provisioning** — `platform/cloud/aws/cluster/`, `platform/cloud/gcp/cluster/`,
...
resources in `platform/cloud/modules/platform/main.tf`. Local development expresses
...
- `cmd_local.ml` and `platform/cloud/modules/platform/main.tf` both get smaller and
