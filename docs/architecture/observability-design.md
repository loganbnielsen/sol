...
All four files are provisioned by `platform/cloud/modules/platform/main.tf`.
...
- `platform/cloud/aws/cluster/main.tf` describes each managed resource generically
...
- `platform/cloud/modules/platform/main.tf` provisions one Grafana dashboard per
