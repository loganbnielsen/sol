...
**Description:** `packages/sol-kafka/`, `packages/sol-obs/`, and the migrated `examples/pluto/app/demo_ts/{order_svc,fulfillment_worker}` (built via FEAT-034/035/038/039, with a real live cross-service trace-linked run proving they work) are not mentioned anywhere in `README.md`, `docs/guides/TUTORIAL.md`, or `docs/ROADMAP.md`.
