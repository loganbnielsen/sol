...
- **State:** (a) and (b) `FIXED_UNQUALIFIED` (BUG-046, 2026-09-24: external stop reaches the server; malformed PORT is a Config error; tests + mutation checks). (c) stays `OPEN` under INFRA-073.
