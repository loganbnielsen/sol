...
- **State:** `FIXED_UNQUALIFIED` (BUG-047, 2026-09-24: one handler per process, registrations signalled together, fd removed before close, disposition restored, second signal terminates; tests + mutation check)
