...
Locations:
- `~/Code/sun/cli/sun/bin/cmd_dev.ml`
- `~/Code/sun/platform/infra/base/main.tf`
...
Locations:
- `~/Code/sun/cli/sun/lib/sun_cli_dev_observability.ml` (`alloy_config_river`, `alloy_values_yaml`)
- `~/Code/sun/platform/infra/base/alloy/logs.alloy.tftpl`
...
Locations:
- `~/Code/sun/cli/sun/lib/sun_cli_dev_observability.ml` (four `*_json` bindings)
- `~/Code/sun/platform/infra/base/dashboards/*.json`
...
Locations:
- `~/Code/sun/cli/sun/lib/sun_cli_manifest_yaml.ml` (`render`, lines ~569-637)
- `~/Code/sun/cli/sun/lib/sun_cli_manifest.mli` (re-export + stale comment)
- `~/Code/sun/cli/sun/test/test_manifest_render.ml` (`test_svc_render_spec_matches_render`)
