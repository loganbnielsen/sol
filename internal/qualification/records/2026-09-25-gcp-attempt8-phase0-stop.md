...
| Operator values used | `IMPERSONATOR=user:lbendtlynielsen@gmail.com`, `LE_EMAIL=qualification@sol-harden-qualification.dev` (the address recorded as verified live against the ACME server — `internal/qualification/records/2026-09-19-aws-run5-attempt3.md`) |
